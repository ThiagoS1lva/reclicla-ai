...
var Alert = React16.forwardRef((uncontrolledProps, ref) => {
  ...
  return (0, import_jsx_runtime11.jsx)(Transition2, {
    unmountOnExit: true,
    ...props,
    ref: void 0,
    in: show,
...
function useUpdateEffect(fn2, deps) {
  var isFirst = (0, import_react14.useRef)(true);
...
function useSafeState(state) {
  var isMounted = useMounted();
  return [state[0], (0, import_react20.useCallback)(function(nextState) {
    if (!isMounted())
      return;
...
var $704cf1d3b684cc5c$var$SSRContext = (0, import_react24.default).createContext($704cf1d3b684cc5c$var$defaultContext);
function $704cf1d3b684cc5c$export$9f8ac96af4b1b2ae(props) {
  let cur = (0, import_react24.useContext)($704cf1d3b684cc5c$var$SSRContext);
  ...
  return (0, import_react24.default).createElement($704cf1d3b684cc5c$var$SSRContext.Provider, {
    value
  }, props.children);
}
...
function $704cf1d3b684cc5c$var$useCounter(isDisabled = false) {
  let ctx = (0, import_react24.useContext)($704cf1d3b684cc5c$var$SSRContext);
...
var Context = (0, import_react27.createContext)(canUseDOM_default ? window : void 0);
var WindowProvider = Context.Provider;
function useWindow() {
  return (0, import_react27.useContext)(Context);
}
...
var Switch = React52.forwardRef((props, ref) => (0, import_jsx_runtime47.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var Image = React56.forwardRef(({
  ...
  return (0, import_jsx_runtime52.jsx)("img", {
...
var FigureImage = React57.forwardRef(({
  ...
  fluid = true,
  ...props
}, ref) => (0, import_jsx_runtime53.jsx)(Image_default, {
  ref,
  ...props,
  fluid,
...
var InputGroupCheckbox = (props) => (0, import_jsx_runtime54.jsx)(InputGroupText, {
  children: (0, import_jsx_runtime54.jsx)(FormCheckInput_default, {
    type: "checkbox",
    ...props
  })
});
var InputGroupRadio = (props) => (0, import_jsx_runtime54.jsx)(InputGroupText, {
  children: (0, import_jsx_runtime54.jsx)(FormCheckInput_default, {
    type: "radio",
    ...props
  })
...
var InputGroup = React58.forwardRef(({
  ...
  return (0, import_jsx_runtime54.jsx)(InputGroupContext_default.Provider, {
    value: contextValue,
...
var NavItem = React60.forwardRef((_ref, ref) => {
  ...
  return (0, import_jsx_runtime55.jsx)(Component2, Object.assign({}, options, props, {
    ref
  }));
});
...
var Nav = React61.forwardRef((_ref, ref) => {
  ...
  return (0, import_jsx_runtime56.jsx)(SelectableContext_default.Provider, {
    value: handleSelect,
    children: (0, import_jsx_runtime56.jsx)(NavContext_default.Provider, {
      value: {
        role,
      ...
      children: (0, import_jsx_runtime56.jsx)(Component2, Object.assign({}, props, {
        onKeyDown: handleKeyDown,
        ref: mergedRef,
        role
      }))
...
function useWaitForDOMRef(ref, onResolved) {
  const window2 = useWindow();
  const [resolvedRef, setRef] = (0, import_react44.useState)(() => resolveContainerRef(ref, window2 == null ? void 0 : window2.document));
  if (!resolvedRef) {
...
function NoopTransition({
  ...
  const hasEnteredRef = (0, import_react45.useRef)(inProp);
  ...
  const child = (0, import_react45.cloneElement)(children, {
    ref: combinedRef
  });
  if (inProp)
    return child;
...
function useTransition({
  ...
  const isInitialRef = (0, import_react46.useRef)(true);
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react46.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default(ref, children.ref);
  return exited && !inProp ? null : (0, import_react46.cloneElement)(children, {
    ref: combinedRef
  });
}
function renderTransition(Component2, runTransition, props) {
  if (Component2) {
    return (0, import_jsx_runtime59.jsx)(Component2, Object.assign({}, props));
  }
  if (runTransition) {
    return (0, import_jsx_runtime59.jsx)(ImperativeTransition, Object.assign({}, props, {
      transition: runTransition
    }));
  }
  return (0, import_jsx_runtime59.jsx)(NoopTransition_default, Object.assign({}, props));
}
...
function useModalManager(provided) {
  ...
  const modal = (0, import_react47.useRef)({
    dialog: null,
    backdrop: null
  });
  return Object.assign(modal.current, {
    ...
    setDialogRef: (0, import_react47.useCallback)((ref) => {
      modal.current.dialog = ref;
    }, []),
    setBackdropRef: (0, import_react47.useCallback)((ref) => {
      modal.current.backdrop = ref;
    }, [])
  });
}
var Modal = (0, import_react47.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
    ...
    restoreFocusOptions,
    renderDialog,
    renderBackdrop = (props) => (0, import_jsx_runtime60.jsx)("div", Object.assign({}, props)),
  ...
  const [exited, setExited] = (0, import_react47.useState)(!show);
  const lastFocusRef = (0, import_react47.useRef)(null);
  (0, import_react47.useImperativeHandle)(ref, () => modal, [modal]);
  ...
  const removeFocusListenerRef = (0, import_react47.useRef)();
  const removeKeydownListenerRef = (0, import_react47.useRef)();
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime60.jsx)("div", Object.assign({}, dialogProps, {
    children: React65.cloneElement(children, {
      role: "document"
    })
  }));
  ...
  return (0, import_jsx_runtime60.jsx)(import_jsx_runtime61.Fragment, {
    children: import_react_dom3.default.createPortal((0, import_jsx_runtime62.jsxs)(import_jsx_runtime61.Fragment, {
...
var ModalContext = React66.createContext({
...
var ModalDialog = React67.forwardRef(({
  bsPrefix,
  className,
  contentClassName,
  centered,
...
var AbstractModalHeader = React68.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
  ...
  const context5 = (0, import_react48.useContext)(ModalContext_default);
  ...
  return (0, import_jsx_runtime65.jsxs)("div", {
    ref,
    ...props,
    children: [children, closeButton && (0, import_jsx_runtime64.jsx)(CloseButton_default, {
      "aria-label": closeLabel,
      variant: closeVariant,
      onClick: handleClick
    })]
...
var ModalHeader = React69.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var Modal2 = React70.forwardRef(({
  ...
  const [modalStyle, setStyle] = (0, import_react49.useState)({});
  const [animateStaticModal, setAnimateStaticModal] = (0, import_react49.useState)(false);
  const waitingForMouseUpRef = (0, import_react49.useRef)(false);
  const ignoreBackdropClickRef = (0, import_react49.useRef)(false);
  const removeStaticModalAnimationRef = (0, import_react49.useRef)(null);
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime67.jsx)("div", {
    ...
    "aria-labelledby": ariaLabelledby,
    "aria-describedby": ariaDescribedby,
    children: (0, import_jsx_runtime67.jsx)(Dialog, {
      ...props,
  ...
  return (0, import_jsx_runtime67.jsx)(ModalContext_default.Provider, {
    value: modalContext,
...
var NavLink = React71.forwardRef(({
  bsPrefix,
  className,
  as: Component2 = Anchor_default,
  active,
...
var Nav2 = React72.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
    bsPrefix: initialBsPrefix,
    variant,
  ...
  let isNavbar = false;
  const navbarContext = (0, import_react50.useContext)(NavbarContext_default);
  const cardHeaderContext = (0, import_react50.useContext)(CardHeaderContext_default);
  if (navbarContext) {
  ...
  return (0, import_jsx_runtime69.jsx)(Nav_default, {
    as,
    ref,
    activeKey,
...
var NavbarBrand = React73.forwardRef(({
  bsPrefix,
  className,
  as,
  ...props
...
var NavbarCollapse = React74.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
  bsPrefix = useBootstrapPrefix(bsPrefix, "navbar-collapse");
  const context5 = (0, import_react51.useContext)(NavbarContext_default);
  return (0, import_jsx_runtime71.jsx)(Collapse_default, {
...
var NavbarToggle = React75.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  const {
    onToggle,
    expanded
  } = (0, import_react52.useContext)(NavbarContext_default) || {};
  ...
  return (0, import_jsx_runtime72.jsx)(Component2, {
    ...
    children: children || (0, import_jsx_runtime72.jsx)("span", {
...
function useMediaQuery(query, targetWindow) {
  ...
  var _useState = (0, import_react53.useState)(function() {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    var query = (0, import_react54.useMemo)(function() {
...
var OffcanvasToggling = React76.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
  ...
  return (0, import_jsx_runtime73.jsx)(TransitionWrapper_default, {
    ref,
    addEndListener: transitionEndListener,
    in: inProp,
    mountOnEnter,
    ...
    ...props,
    childRef: children.ref,
    children: (status, innerProps) => React76.cloneElement(children, {
      ...innerProps,
...
var OffcanvasHeader = React77.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
function DialogTransition2(props) {
  return (0, import_jsx_runtime75.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
...
var Offcanvas = React78.forwardRef(({
  bsPrefix,
  className,
  children,
  "aria-labelledby": ariaLabelledby,
  ...
  const modalManager = (0, import_react55.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const {
    onToggle
  } = (0, import_react55.useContext)(NavbarContext_default) || {};
  const [showOffcanvas, setShowOffcanvas] = (0, import_react55.useState)(false);
  ...
  const modalContext = (0, import_react55.useMemo)(() => ({
    onHide: handleHide
  }), [handleHide]);
  function getModalManager() {
    if (propsManager)
  ...
  const renderBackdrop = (0, import_react55.useCallback)((backdropProps) => (0, import_jsx_runtime75.jsx)("div", {
    ...backdropProps,
  ...
  return (0, import_jsx_runtime77.jsxs)(import_jsx_runtime76.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime75.jsx)(ModalContext_default.Provider, {
      value: modalContext,
...
var NavbarOffcanvas = React79.forwardRef((props, ref) => {
  const context5 = (0, import_react56.useContext)(NavbarContext_default);
  return (0, import_jsx_runtime78.jsx)(Offcanvas_default, {
    ref,
...
var Navbar = React80.forwardRef((props, ref) => {
  const {
    bsPrefix: initialBsPrefix,
    expand = true,
    variant = "light",
  ...
  const handleCollapse = (0, import_react57.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react57.useMemo)(() => ({
    onToggle: () => onToggle == null ? void 0 : onToggle(!expanded),
    bsPrefix,
    expanded: !!expanded,
    expand
  }), [bsPrefix, expanded, expand, onToggle]);
  return (0, import_jsx_runtime79.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
...
var NavDropdown = React81.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React82.forwardRef((props, outerRef) => {
  const {
    flip: flip2,
    offset: offset2,
    placement,
...
var Overlay2 = React85.forwardRef(({
  ...
  const popperRef = (0, import_react61.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react61.useState)(null);
  ...
  return (0, import_jsx_runtime84.jsx)(Overlay_default, {
    ...outerProps,
    ref: mergedRef,
    popperConfig: {
      ...popperConfig,
    ...
    children: (overlayProps, {
      ...
      return React85.cloneElement(overlay, {
        ...
        popper: popper2,
        hasDoneInitialMeasure,
        className: (0, import_classnames53.default)(overlay.props.className, !transition && show && "show"),
        style: {
          ...overlay.props.style,
          ...overlayProps.style
        }
...
function OverlayTrigger({
  ...
  const triggerNodeRef = (0, import_react62.useRef)(null);
  const mergedRef = useMergedRefs_default(triggerNodeRef, children.ref);
  const timeout2 = useTimeout();
  const hoverStateRef = (0, import_react62.useRef)("");
  ...
  const handleShow = (0, import_react62.useCallback)(() => {
    timeout2.clear();
  ...
  const handleHide = (0, import_react62.useCallback)(() => {
    timeout2.clear();
  ...
  const handleFocus = (0, import_react62.useCallback)((...args) => {
    handleShow();
    onFocus == null ? void 0 : onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react62.useCallback)((...args) => {
    handleHide();
    onBlur == null ? void 0 : onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react62.useCallback)((...args) => {
    setShow(!show);
    onClick == null ? void 0 : onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react62.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react62.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime87.jsxs)(import_jsx_runtime86.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react62.cloneElement)(children, triggerProps), (0, import_jsx_runtime85.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var ProgressBar = React90.forwardRef(({
  ...
  return (0, import_jsx_runtime91.jsx)("div", {
    ...
    children: children ? map(children, (child) => (0, import_react63.cloneElement)(child, {
      isChild: true
    })) : renderProgressBar({
      min: min2,
      now,
...
function useTabPanel(_ref) {
  ...
  const context5 = (0, import_react64.useContext)(TabContext_default);
  if (!context5)
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react65.useMemo)(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
  const tabContext = (0, import_react65.useMemo)(() => ({
    onSelect,
    activeKey,
    transition,
...
var TabPane = React99.forwardRef(({
  ...
  return (0, import_jsx_runtime101.jsx)(TabContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime101.jsx)(SelectableContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime101.jsx)(Transition2, {
        in: isActive,
        onEnter,
        onEntering,
        onEntered,
...
var Tab = () => {
  ...
  return (0, import_jsx_runtime103.jsx)(import_jsx_runtime102.Fragment, {});
};
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime105.jsx)(NavItem_default2, {
    as: "li",
    role: "presentation",
...
var ToastFade = React103.forwardRef((props, ref) => (0, import_jsx_runtime107.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React105.forwardRef(({
  ...
  const context5 = (0, import_react66.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
...
var Toast = React106.forwardRef(({
  ...
  const delayRef = (0, import_react67.useRef)(delay);
  const onCloseRef = (0, import_react67.useRef)(onClose);
  ...
  const autohideFunc = (0, import_react67.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react67.useMemo)(() => ({
    onClose
  }), [onClose]);
  ...
  const toast = (0, import_jsx_runtime110.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames64.default)(bsPrefix, className, bg && `bg-${bg}`, !hasAnimation && (show ? "show" : "hide")),
    role: "alert",
    "aria-live": "assertive",
    "aria-atomic": "true"
  });
...
var ToastContainer = React107.forwardRef(({
  ...
  return (0, import_jsx_runtime111.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames65.default)(bsPrefix, position && positionClasses[position], containerPosition && `position-${containerPosition}`, className)
  });
});
...
var ToggleButton = React108.forwardRef(({
  ...
  return (0, import_jsx_runtime114.jsxs)(import_jsx_runtime113.Fragment, {
    children: [(0, import_jsx_runtime112.jsx)("input", {
      ...
      ...props,
      ref,
      className: (0, import_classnames66.default)(className, disabled && "disabled"),
      type: void 0,
      role: void 0,
      as: "label",
      htmlFor: id
